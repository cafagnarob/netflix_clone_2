  ...
  /* 
        ...
        <div class="row d-flex justify-content-lg-center">
          <div class="col-12 col-lg-4">
            <hr class="mt-3" />
            <div class="row">
              <div class="col-12 col-lg-2 mt-2 mt-md-0 d-grid mb-2">
                <button
                  type="button"
                  class="btn bg-transparent border-1 border-secondary rounded-0 text-secondary"
                >
                  SAVE
                </button>
              </div>
              <div class="col-12 col-lg-4 mt-2 mt-md-0 d-grid mb-2">
                <button
                  type="button"
                  class="btn bg-transparent border-1 border-secondary rounded-0 text-secondary"
                >
              ...
              <div class="col-12 col-lg-6 mt-2 mt-md-0 d-grid mb-2">
                <button
                  type="button"
                  class="btn bg-transparent border-1 border-secondary rounded-0 text-secondary"
                >
